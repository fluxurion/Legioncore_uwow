...
enum HotfixDatabaseStatements
{
    ...
    */
    ...
    HOTFIX_SEL_L_F_G_DUNGEON,
    HOTFIX_SEL_L_F_G_DUNGEON_LOCALE,
    ...
    HOTFIX_SEL_VEHICLE,
    HOTFIX_SEL_VEHICLE_LOCALE,

    HOTFIX_SEL_W_M_O_AREA_TABLE,
    HOTFIX_SEL_W_M_O_AREA_TABLE_LOCALE,
    ...
    HOTFIX_SEL_CHAR_SHIPMENT_CONTEINER,
    HOTFIX_SEL_CHAR_SHIPMENT_CONTEINER_LOCALE,
    ...
    HOTFIX_SEL_SPECIALIZATION_SPELL,
    HOTFIX_SEL_SPECIALIZATION_SPELL_LOCALE,
