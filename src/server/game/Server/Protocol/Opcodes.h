...
enum OpcodeClient : uint32
{
    ...
    CMSG_BATTLE_PAY_GET_PRODUCT_LIST                  = 0xBADD,
    CMSG_BATTLE_PAY_GET_PURCHASE_LIST                 = 0xBADD,
    ...
    CMSG_LOADING_SCREEN_NOTIFY                        = 0xBADD,
...
enum OpcodeServer : uint32
{
    ...
    SMSG_ACCOUNT_DATA_TIMES                           = 0xBADD,
    ...
    SMSG_ENUM_CHARACTERS_RESULT                       = 0xBADD,
    ...
    SMSG_LOGIN_SET_TIME_SPEED                         = 0xBADD,
    ...
    SMSG_SET_TIME_ZONE_INFORMATION                    = 0xBADD,
