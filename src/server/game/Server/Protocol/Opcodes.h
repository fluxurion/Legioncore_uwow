...
enum OpcodeServer : uint16
{
    ...
    SMSG_CHARACTER_OBJECT_TEST_RESPONSE               = 0x27C3,
    SMSG_CHARACTER_RENAME_RESULT                      = 0x2704,
    ...
    SMSG_LIVE_REGION_ACCOUNT_RESTORE_RESULT           = 0x27AB,
    SMSG_LIVE_REGION_CHARACTER_COPY_RESULT            = 0x27A9,
    ...
    SMSG_SET_PLAYER_DECLINED_NAMES_RESULT             = 0x2716,
    ...
    SMSG_SET_VEHICLE_REC_ID                           = 0x2DE0,
