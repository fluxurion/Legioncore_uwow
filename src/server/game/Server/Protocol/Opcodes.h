...
enum OpcodeClient : uint16
{
    ...
    CMSG_AUTO_EQUIP_ITEM                              = 0x399D,
    CMSG_AUTO_EQUIP_ITEM_SLOT                         = 0x399A,
    ...
    CMSG_MOVE_GRAVITY_DISABLE_ACK                     = 0x3A1F,
...
enum OpcodeServer : uint16
{
    ...
    SMSG_BATTLE_PAY_ACK_FAILED                        = 0x2821,
    ...
    SMSG_CHALLENGE_MODE_NEW_PLAYER_RECORD             = 0x261D,
    ...
    SMSG_CHARACTER_UPGRADE_CHARACTER_CHOSEN           = 0x27F4,
    ...
    SMSG_GARRISON_RECRUIT_FOLLOWER_RESULT             = 0x2765,
    ...
    SMSG_GET_TROPHY_LIST_RESPONSE                     = 0x27F8,
    ...
    SMSG_GUILD_MOVE_STARTING                          = 0x2786,
    ...
    SMSG_GUILD_PERMISSIONS_QUERY_RESULTS              = 0x275E,
    ...
    SMSG_INSTANCE_ENCOUNTER_CHANGE_PRIORITY           = 0x27E8,
    SMSG_INSTANCE_ENCOUNTER_DISENGAGE_UNIT            = 0x27E7,
    SMSG_INSTANCE_ENCOUNTER_END                       = 0x27EE,
    SMSG_INSTANCE_ENCOUNTER_ENGAGE_UNIT               = 0x27E6,
    SMSG_INSTANCE_ENCOUNTER_GAIN_COMBAT_RESURRECTION_CHARGE = 0xBADD,
    SMSG_INSTANCE_ENCOUNTER_IN_COMBAT_RESURRECTION    = 0x27EF,
    SMSG_INSTANCE_ENCOUNTER_OBJECTIVE_COMPLETE        = 0x27EB,
    SMSG_INSTANCE_ENCOUNTER_OBJECTIVE_START           = 0x27EA,
    SMSG_INSTANCE_ENCOUNTER_OBJECTIVE_UPDATE          = 0x27ED,
    SMSG_INSTANCE_ENCOUNTER_PHASE_SHIFT_CHANGED       = 0x27F1,
    SMSG_INSTANCE_ENCOUNTER_START                     = 0x27EC,
    ...
    SMSG_LOAD_SELECTED_TROPHY_RESULT                  = 0x27F9,
    ...
    SMSG_QUEST_UPDATE_ADD_CREDIT_SIMPLE               = 0x26F6,
    ...
    SMSG_READ_ITEM_RESULT_FAILED                      = 0x27DF,
    ...
    SMSG_RECRUIT_A_FRIEND_RESPONSE                    = 0x2756,
    ...
    SMSG_REPLACE_TROPHY_RESPONSE                      = 0x27F7,
