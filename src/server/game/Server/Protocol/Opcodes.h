...
enum OpcodeClient : uint16
{
    ...
    CMSG_ACCEPT_WARGAME_INVITE                        = 0x35EE,
    ...
    CMSG_COMMENTATOR_ENABLE                           = 0x36EA,
    ...
    CMSG_LOAD_SELECTED_TROPHY                         = 0x32CF,
    ...
    CMSG_MAIL_CREATE_TEXT_ITEM                        = 0x3524,
    CMSG_MAIL_DELETE                                  = 0xBADD,
    CMSG_MAIL_GET_LIST                                = 0x351F,
    CMSG_MAIL_MARK_AS_READ                            = 0x3523,
    CMSG_MAIL_RETURN_TO_SENDER                        = 0xBADD,
    CMSG_MAIL_TAKE_ITEM                               = 0x3521,
    CMSG_MAIL_TAKE_MONEY                              = 0x3520,
    ...
    CMSG_SET_BACKPACK_AUTOSORT_DISABLED               = 0x32F1,
    ...
    CMSG_SIGN_PETITION                                = 0x351C,
    CMSG_SILENCE_PARTY_TALKER                         = 0xBADD,
    CMSG_SOCKET_GEMS                                  = 0xBADD,
    CMSG_SORT_BAGS                                    = 0x32F4,
    CMSG_SORT_BANK_BAGS                               = 0x32F6,
    CMSG_SORT_REAGENT_BANK_BAGS                       = 0x32F7,
    ...
    CMSG_UPDATE_WOW_TOKEN_AUCTIONABLE_LIST            = 0x36EB,
...
enum OpcodeServer : uint16
{
    ...
    SMSG_MOVE_SET_WATER_WALK                          = 0x2DCB,
    ...
    SMSG_MOVE_SPLINE_SET_HOVER                        = 0x2DEE,
    ...
    SMSG_MOVE_SPLINE_UNSET_HOVER                      = 0x2DED,
    SMSG_MOVE_TELEPORT                                = 0x2DD2,
    SMSG_MOVE_UNROOT                                  = 0x2DCA,
    ...
    SMSG_QUERY_BATTLE_PET_NAME_RESPONSE               = 0x2702,
    ...
    SMSG_QUERY_ITEM_TEXT_RESPONSE                     = 0x27FB,
    SMSG_QUERY_NPC_TEXT_RESPONSE                      = 0x26FB,
    SMSG_QUERY_PAGE_TEXT_RESPONSE                     = 0x2700,
    SMSG_QUERY_PET_NAME_RESPONSE                      = 0x2701,
    ...
    SMSG_SEND_RAID_TARGET_UPDATE_SINGLE               = 0x264A,
    ...
    SMSG_TALENTS_INVOLUNTARILY_RESET                  = 0x2755,
    ...
    SMSG_UI_TIME                                      = 0x2751,
    SMSG_UNDELETE_CHARACTER_RESPONSE                  = 0x2802,
    ...
    SMSG_UPDATE_CHARACTER_FLAGS                       = 0x27F7,
