...
enum OpcodeClient : uint16
{
    ...
    CMSG_BATTLEMASTER_JOIN                            = 0x350C,
    CMSG_BATTLEMASTER_JOIN_ARENA                      = 0xBADD,
    CMSG_BATTLEMASTER_JOIN_SKIRMISH                   = 0x350E,
    ...
    CMSG_BLACK_MARKET_BID_ON_ITEM                     = 0x3516,
    CMSG_BLACK_MARKET_OPEN                            = 0xBADD,
    CMSG_BLACK_MARKET_REQUEST_ITEMS                   = 0x3515,
    ...
    CMSG_CHANGE_MONUMENT_APPEARANCE                   = 0x32D1,
    ...
    CMSG_DECLINE_GUILD_INVITES                        = 0x350A,
    ...
    CMSG_GARRISON_GET_BUILDING_LANDMARKS              = 0x32BC,
    ...
    CMSG_ITEM_PURCHASE_REFUND                         = 0x3519,
    CMSG_ITEM_TEXT_QUERY                              = 0x32EC,
    ...
    CMSG_REVERT_MONUMENT_APPEARANCE                   = 0x32D2,
    ...
    CMSG_SET_BACKPACK_AUTOSORT_DISABLED               = 0x32F2,
    ...
    CMSG_SET_USING_PARTY_GARRISON                     = 0x32B9,
...
enum OpcodeServer : uint16
{
    ...
    SMSG_AREA_TRIGGER_DENIED                          = 0x269B,
    ...
    SMSG_ATTACK_SWING_LANDED_LOG                      = 0x2733,
    ...
    SMSG_BLACK_MARKET_BID_ON_ITEM_RESULT              = 0x2643,
    SMSG_BLACK_MARKET_OPEN_RESULT                     = 0x2641,
    SMSG_BLACK_MARKET_OUTBID                          = 0x2644,
    ...
    SMSG_CALENDAR_CLEAR_PENDING_ACTION                = 0x26C4,
    SMSG_CALENDAR_COMMAND_RESULT                      = 0x26C5,
    ...
    SMSG_CALENDAR_SEND_CALENDAR                       = 0x26B2,
    ...
    SMSG_DUEL_IN_BOUNDS                               = 0x2670,
    SMSG_DUEL_OUT_OF_BOUNDS                           = 0x266F,
    ...
    SMSG_FORCED_DEATH_UPDATE                          = 0x2705,
    ...
    SMSG_GM_TICKET_CASE_STATUS                        = 0x26CB,
    ...
    SMSG_GM_TICKET_SYSTEM_STATUS                      = 0x26CA,
    ...
    SMSG_HIGHEST_THREAT_UPDATE                        = 0x270B,
    ...
    SMSG_INSTANCE_RESET                               = 0x26AD,
    SMSG_INSTANCE_RESET_FAILED                        = 0x26AE,
    ...
    SMSG_OFFER_PETITION_ERROR                         = 0x26DF,
    SMSG_ON_CANCEL_EXPECTED_RIDE_VEHICLE_AURA         = 0x271B,
    ...
    SMSG_PET_DISMISS_SOUND                            = 0x26C8,
    SMSG_PET_GOD_MODE                                 = 0x26A2,
    SMSG_PET_GUIDS                                    = 0x2740,
    ...
    SMSG_UPDATE_INSTANCE_OWNERSHIP                    = 0x26CF,
