...
enum OpcodeClient : uint16
{
    ...
    CMSG_BATTLE_PET_REQUEST_JOURNAL                   = 0x31CA,
    ...
    CMSG_MOVE_SET_COLLISION_HEIGHT_ACK                = 0x3249,
...
enum OpcodeServer : uint16
{
    ...
    SMSG_CHAR_FACTION_CHANGE_RESULT                   = 0x27DF,
    ...
    SMSG_PARTY_COMMAND_RESULT                         = 0x27CD,
    ...
    SMSG_QUEST_UPDATE_ADD_CREDIT_SIMPLE               = 0x26F7,
    ...
    SMSG_SPELL_NON_MELEE_DAMAGE_LOG                   = 0x2676,
    ...
    SMSG_UPDATE_CHARACTER_FLAGS                       = 0x27F3,
