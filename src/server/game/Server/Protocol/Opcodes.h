...
enum OpcodeClient : uint16
{
    ...
    CMSG_SET_ALLOW_LOW_LEVEL_RAID                     = 0x36A5,
...
enum OpcodeServer : uint16
{
    ...
    SMSG_AUCTION_REPLICATE_RESPONSE                   = 0x2723,
    ...
    SMSG_BATTLEGROUND_CAPTURE_POINT_INFO              = 0x279E,
    ...
    SMSG_LFG_SEARCH_RESULTS                           = 0x2A2C,
    ...
    SMSG_UPDATE_WOW_TOKEN_COUNT_RESPONSE              = 0x2808,
    ...
    SMSG_WOW_TOKEN_AUCTION_SOLD                       = 0x280D,
    SMSG_WOW_TOKEN_BUY_REQUEST_CONFIRMATION           = 0x280F,
    SMSG_WOW_TOKEN_BUY_RESULT_CONFIRMATION            = 0x2810,
    SMSG_WOW_TOKEN_MARKET_PRICE_RESPONSE              = 0x280A,
    SMSG_WOW_TOKEN_REDEEM_GAME_TIME_UPDATED           = 0x2811,
    SMSG_WOW_TOKEN_REDEEM_REQUEST_CONFIRMATION        = 0x2812,
    SMSG_WOW_TOKEN_REDEEM_RESULT                      = 0x2813,
    SMSG_WOW_TOKEN_SELL_REQUEST_CONFIRMATION          = 0x280B,
    SMSG_WOW_TOKEN_SELL_RESULT_CONFIRMATION           = 0x280C,
    SMSG_WOW_TOKEN_UPDATE_AUCTIONABLE_LIST_RESPONSE   = 0x2814,
