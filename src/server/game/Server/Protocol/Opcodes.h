...
enum OpcodeClient : uint16
{
    ...
    CMSG_CANCEL_MOD_SPEED_NO_CONTROL_AURAS            = 0x31C1,
    ...
    CMSG_REQUEST_CHALLENGE_MODE_LEADERS               = 0x308F,
    CMSG_CHALLENGE_MODE_REQUEST_MAP_STATS             = 0x308E,
    CMSG_SET_BAG_SLOT_FLAG                            = 0x32EF,
    ...
    CMSG_CLIENT_PORT_GRAVEYARD                        = 0x3511,
    ...
    CMSG_COMPLETE_CINEMATIC                           = 0x352E,
    ...
    CMSG_DECLINE_GUILD_INVITES                        = 0x3060,
    ...
    CMSG_GARRISON_CHECK_UPGRADEABLE                   = 0x32BF,
    ...
    CMSG_GARRISON_RECRUIT_FOLLOWER                    = 0x32D4,
    ...
    CMSG_GARRISON_REQUEST_LANDING_PAGE_SHIPMENT_INFO  = 0x32BF,
    ...
    CMSG_REQUEST_CHALLENGE_MODE_REWARDS               = 0x3091,
    ...
    CMSG_GUILD_BANK_TEXT_QUERY                        = 0x3086,
    ...
    CMSG_JOIN_RATED_BATTLEFIELD                       = 0x3175,
    CMSG_KEEP_ALIVE                                   = 0x36A0,
    ...
    CMSG_LFG_LIST_DECLINE_APPLICANT                   = 0x3078,
    ...
    CMSG_MOVE_CHANGE_VEHICLE_SEATS                    = 0x39F6,
    ...
    CMSG_MOVE_FORCE_SWIM_BACK_SPEED_CHANGE_ACK        = 0x3A2F,
    ...
    CMSG_MOVE_TOGGLE_COLLISION_CHEAT                  = 0x3A2D,
    ...
    CMSG_SET_ACTION_BAR_TOGGLES                       = 0x351B,
    ...
    CMSG_SET_BANK_BAG_SLOT_FLAG                       = 0x32F0,
    ...
    CMSG_UPDATE_CLIENT_SETTINGS                       = 0x34FA,
...
enum OpcodeServer : uint16
{
    ...
    SMSG_ACCOUNT_CRITERIA_UPDATE                      = 0x2650,
    SMSG_ACCOUNT_DATA_TIMES                           = 0x2747,
    SMSG_ACCOUNT_MOUNT_UPDATE                         = 0xBADD,
    SMSG_ACCOUNT_TOYS_UPDATE                          = 0xBADD,
    SMSG_ACHIEVEMENT_DELETED                          = 0x271D,
    SMSG_ACHIEVEMENT_EARNED                           = 0x265E,
    SMSG_ACTIVATE_TAXI_REPLY                          = 0x26A4,
    SMSG_ADD_BATTLENET_FRIEND_RESPONSE                = 0xBADD,
    SMSG_ADD_ITEM_PASSIVE                             = 0x25BE,
    SMSG_ADD_LOSS_OF_CONTROL                          = 0x2694,
    SMSG_ADD_RUNE_POWER                               = 0xBADD,
    SMSG_ADDON_INFO                                   = 0x277B,
    SMSG_ADJUST_SPLINE_DURATION                       = 0x25E7,
    ...
    SMSG_AREA_TRIGGER_RE_SHAPE                        = 0x263F,
    SMSG_ARENA_ERROR                                  = 0x2710,
    SMSG_ARENA_PREP_OPPONENT_SPECIALIZATIONS          = 0x2663,
    SMSG_ATTACK_START                                 = 0x266B,
    SMSG_ATTACK_STOP                                  = 0x266C,
    SMSG_ATTACK_SWING_ERROR                           = 0x2732,
    SMSG_ATTACK_SWING_LANDED_LOG                      = 0xBADD,
    SMSG_ATTACKER_STATE_UPDATE                        = 0x27CA,
    SMSG_AUCTION_CLOSED_NOTIFICATION                  = 0x2727,
    SMSG_AUCTION_COMMAND_RESULT                       = 0x2724,
    SMSG_AUCTION_HELLO_RESPONSE                       = 0x2722,
    SMSG_AUCTION_LIST_BIDDER_ITEMS_RESULT             = 0x272B,
    SMSG_AUCTION_LIST_ITEMS_RESULT                    = 0x2729,
    SMSG_AUCTION_LIST_OWNER_ITEMS_RESULT              = 0x272A,
    SMSG_AUCTION_LIST_PENDING_SALES_RESULT            = 0x272C,
    SMSG_AUCTION_OUTBID_NOTIFICATION                  = 0x2726,
    SMSG_AUCTION_OWNER_BID_NOTIFICATION               = 0x2728,
    SMSG_AUCTION_REPLICATE_RESPONSE                   = 0xBADD,
    SMSG_AUCTION_WON_NOTIFICATION                     = 0x2725,
    ...
    SMSG_BATTLE_PAY_ACK_FAILED                        = 0x2822,
    ...
    SMSG_BATTLE_PET_CAGE_DATE_ERROR                   = 0x269E,
    SMSG_BATTLE_PET_DELETED                           = 0x2606,
    SMSG_BATTLE_PET_ERROR                             = 0x2653,
    ...
    SMSG_BATTLE_PETS_HEALED                           = 0x280D,
    ...
    SMSG_BINDER_CONFIRM                               = 0x2738,
    SMSG_BLACK_MARKET_BID_ON_ITEM_RESULT              = 0xBADD,
    SMSG_BLACK_MARKET_OPEN_RESULT                     = 0x2641,
    SMSG_BLACK_MARKET_OUTBID                          = 0xBADD,
    SMSG_BLACK_MARKET_REQUEST_ITEMS_RESULT            = 0x2642,
    SMSG_BLACK_MARKET_WON                             = 0x2645,
    SMSG_BONUS_ROLL_EMPTY                             = 0x2660,
    SMSG_BOSS_KILL_CREDIT                             = 0xBADD,
    SMSG_BREAK_TARGET                                 = 0x266A,
    SMSG_BUY_FAILED                                   = 0x26F1,
    SMSG_BUY_SUCCEEDED                                = 0x26F0,
    SMSG_CACHE_VERSION                                = 0x2741,
    SMSG_CALENDAR_CLEAR_PENDING_ACTION                = 0xBADD,
    SMSG_CALENDAR_COMMAND_RESULT                      = 0xBADD,
    SMSG_CALENDAR_EVENT_INITIAL_INVITES               = 0x26B4,
    SMSG_CALENDAR_EVENT_INVITE                        = 0x26BA,
    SMSG_CALENDAR_EVENT_INVITE_ALERT                  = 0xBADD,
    SMSG_CALENDAR_EVENT_INVITE_MODERATOR_STATUS       = 0x26B9,
    SMSG_CALENDAR_EVENT_INVITE_NOTES                  = 0x26BE,
    SMSG_CALENDAR_EVENT_INVITE_NOTES_ALERT            = 0x26BF,
    SMSG_CALENDAR_EVENT_INVITE_REMOVED                = 0xBADD,
    SMSG_CALENDAR_EVENT_INVITE_REMOVED_ALERT          = 0xBADD,
    SMSG_CALENDAR_EVENT_INVITE_STATUS                 = 0x26B7,
    SMSG_CALENDAR_EVENT_INVITE_STATUS_ALERT           = 0x26B8,
    SMSG_CALENDAR_EVENT_REMOVED_ALERT                 = 0x26BC,
    SMSG_CALENDAR_EVENT_UPDATED_ALERT                 = 0x26B5,
    SMSG_CALENDAR_RAID_LOCKOUT_ADDED                  = 0x26C0,
    ...
    SMSG_CALENDAR_SEND_NUM_PENDING                    = 0x26C3,
    SMSG_CAMERA_SHAKE                                 = 0xBADD,
    SMSG_CAN_DUEL_RESULT                              = 0x2674,
    SMSG_CANCEL_AUTO_REPEAT                           = 0x2711,
    SMSG_CANCEL_COMBAT                                = 0x2730,
    ...
    SMSG_CHALLEGE_MODE_REWARDS                        = 0x2620,
    ...
    SMSG_CHANGE_PLAYER_DIFFICULTY_RESULT              = 0x2734,
    ...
    SMSG_CHAR_CUSTOMIZE_FAILED                        = 0x2717,
    SMSG_CHAR_FACTION_CHANGE_RESULT                   = 0xBADD,
    SMSG_CHARACTER_LOGIN_FAILED                       = 0xBADD,
    SMSG_CHARACTER_OBJECT_TEST_RESPONSE               = 0x27C4,
    SMSG_CHARACTER_RENAME_RESULT                      = 0x2705,
    SMSG_CHARACTER_UPGRADE_CHARACTER_CHOSEN           = 0x27F5,
    SMSG_CHARACTER_UPGRADE_COMPLETE                   = 0x27F4,
    ...
    SMSG_CLEAR_LOSS_OF_CONTROL                        = 0x2696,
    SMSG_CLEAR_SPELL_CHARGES                          = 0x2C27,
    SMSG_CLEAR_TARGET                                 = 0xBADD,
    SMSG_COIN_REMOVED                                 = 0xBADD,
    SMSG_COMBAT_EVENT_FAILED                          = 0x266D,
    SMSG_COMMENTATOR_MAP_INFO                         = 0x2744,
    SMSG_COMMENTATOR_PLAYER_INFO                      = 0x2745,
    SMSG_COMMENTATOR_STATE_CHANGED                    = 0x2743,
    SMSG_COMPLAINT_RESULT                             = 0x26D2,
    ...
    SMSG_CONSOLE_WRITE                                = 0x26CD,
    SMSG_CONTACT_LIST                                 = 0x27C5,
    SMSG_CONTROL_UPDATE                               = 0x2662,
    ...
    SMSG_DUEL_COMPLETE                                = 0x2672,
    SMSG_DUEL_COUNTDOWN                               = 0x2671,
    SMSG_DUEL_IN_BOUNDS                               = 0xBADD,
    SMSG_DUEL_OUT_OF_BOUNDS                           = 0xBADD,
    SMSG_DUEL_REQUESTED                               = 0x266E,
    ...
    SMSG_GAME_SPEED_SET                               = 0x26A8,
    SMSG_GAME_TIME_SET                                = 0xBADD,
    SMSG_GAME_TIME_UPDATE                             = 0x2748,
    ...
    SMSG_GARRISON_RECRUIT_FOLLOWER_RESULT             = 0x2766,
    ...
    SMSG_GET_TROPHY_LIST_RESPONSE                     = 0x27F9,
    ...
    SMSG_GUILD_MOVE_STARTING                          = 0x2787,
    ...
    SMSG_LFG_ROLE_CHECK_UPDATE                        = 0x2A22,
    ...
    SMSG_LOAD_EQUIPMENT_SET                           = 0x274B,
    SMSG_LOAD_SELECTED_TROPHY_RESULT                  = 0x27FA,
    SMSG_LOG_XP_GAIN                                  = 0x271A,
    SMSG_LOGIN_SET_TIME_SPEED                         = 0x274A,
    SMSG_LOGIN_VERIFY_WORLD                           = 0x25AB,
    SMSG_LOGOUT_CANCEL_ACK                            = 0xBADD,
    SMSG_LOGOUT_COMPLETE                              = 0x26AB,
    SMSG_LOGOUT_RESPONSE                              = 0xBADD,
    SMSG_LOOT_ALL_PASSED                              = 0x2635,
    SMSG_LOOT_CONTENTS                                = 0x25F0,
    ...
    SMSG_LOSS_OF_CONTROL_AURA_UPDATE                  = 0x2693,
    SMSG_MAIL_COMMAND_RESULT                          = 0x2656,
    ...
    SMSG_MOVE_SET_FLIGHT_SPEED                        = 0x2DB4,
    ...
    SMSG_MOVE_SPLINE_DISABLE_COLLISION                = 0x2DF5,
    SMSG_MOVE_SPLINE_DISABLE_GRAVITY                  = 0x2DE8,
    SMSG_MOVE_SPLINE_ENABLE_COLLISION                 = 0x2DED,
    SMSG_MOVE_SPLINE_ENABLE_GRAVITY                   = 0x2DEB,
    SMSG_MOVE_SPLINE_ROOT                             = 0x2DE5,
    SMSG_MOVE_SPLINE_SET_FEATHER_FALL                 = 0x2DF0,
    SMSG_MOVE_SPLINE_SET_FLIGHT_BACK_SPEED            = 0x2DBB,
    SMSG_MOVE_SPLINE_SET_FLIGHT_SPEED                 = 0x2DB7,
    SMSG_MOVE_SPLINE_SET_FLYING                       = 0x2DEA,
    SMSG_MOVE_SPLINE_SET_HOVER                        = 0x2DF4,
    SMSG_MOVE_SPLINE_SET_LAND_WALK                    = 0x2DEE,
    SMSG_MOVE_SPLINE_SET_NORMAL_FALL                  = 0x2DF3,
    SMSG_MOVE_SPLINE_SET_PITCH_RATE                   = 0x2DBC,
    SMSG_MOVE_SPLINE_SET_RUN_BACK_SPEED               = 0x2DB9,
    SMSG_MOVE_SPLINE_SET_RUN_MODE                     = 0x2DE9,
    SMSG_MOVE_SPLINE_SET_RUN_SPEED                    = 0x2DBA,
    SMSG_MOVE_SPLINE_SET_SWIM_BACK_SPEED              = 0x2DB8,
    SMSG_MOVE_SPLINE_SET_SWIM_SPEED                   = 0x2DB5,
    SMSG_MOVE_SPLINE_SET_TURN_RATE                    = 0x2DBD,
    SMSG_MOVE_SPLINE_SET_WALK_MODE                    = 0x2DE7,
    SMSG_MOVE_SPLINE_SET_WALK_SPEED                   = 0x2DB6,
    SMSG_MOVE_SPLINE_SET_WALK_BACK_SPEED              = 0x2DBB,
    SMSG_MOVE_SPLINE_SET_WATER_WALK                   = 0x2DF6,
    ...
    SMSG_MOVE_SPLINE_UNSET_HOVER                      = 0x2DEF,
    ...
    SMSG_MOVE_UPDATE_FLIGHT_BACK_SPEED                = 0x2DA6,
    SMSG_MOVE_UPDATE_FLIGHT_SPEED                     = 0x2DA7,
    SMSG_MOVE_UPDATE_KNOCK_BACK                       = 0x2DB0,
    SMSG_MOVE_UPDATE_PITCH_RATE                       = 0x2DAB,
    SMSG_MOVE_UPDATE_REMOVE_MOVEMENT_FORCE            = 0x2DB3,
    SMSG_MOVE_UPDATE_RUN_BACK_SPEED                   = 0x2DA9,
    SMSG_MOVE_UPDATE_RUN_SPEED                        = 0x2DAA,
    SMSG_MOVE_UPDATE_SWIM_BACK_SPEED                  = 0x2DA8,
    SMSG_MOVE_UPDATE_SWIM_SPEED                       = 0x2DA4,
    SMSG_MOVE_UPDATE_TELEPORT                         = 0x2DAF,
    SMSG_MOVE_UPDATE_TURN_RATE                        = 0x2DAC,
    SMSG_MOVE_UPDATE_WALK_SPEED                       = 0x2DA5,
    ...
    SMSG_NOTIFY_MISSILE_TRAJECTORY_COLLISION          = 0x26D0,
    SMSG_NOTIFY_MONEY                                 = 0x25AD,
    SMSG_NOTIFY_RECEIVED_MAIL                         = 0x2657,
    ...
    SMSG_OPEN_LFG_DUNGEON_FINDER                      = 0x27C3,
    ...
    SMSG_PET_BATTLE_QUEUE_PROPOSE_MATCH               = 0x2654,
    SMSG_PET_BATTLE_QUEUE_STATUS                      = 0x2655,
    ...
    SMSG_PET_TAME_FAILURE                             = 0x26DC,
    SMSG_PET_UNLEARNED_SPELLS                         = 0xBADD,
    SMSG_PETITION_ALREADY_SIGNED                      = 0xBADD,
    SMSG_PETITION_RENAME_GUILD_RESPONSE               = 0x264A,
    ...
    SMSG_PROPOSE_LEVEL_GRANT                          = 0x270F,
    ...
    SMSG_QUERY_GAME_OBJECT_RESPONSE                   = 0x26FE,
    ...
    SMSG_REALM_SPLIT                                  = 0x26E2,
    SMSG_RECRUIT_A_FRIEND_RESPONSE                    = 0x2757,
    ...
    SMSG_REMOVE_LOSS_OF_CONTROL                       = 0x2695,
    SMSG_REPLACE_TROPHY_RESPONSE                      = 0x27F8,
    SMSG_REPORT_PVP_PLAYER_AFK_RESULT                 = 0x26D8,
    SMSG_REQUEST_CEMETERY_LIST_RESPONSE               = 0x259E,
    SMSG_REQUEST_PVP_REWARDS_RESPONSE                 = 0xBADD,
    SMSG_WOW_TOKEN_MARKET_PRICE_RESPONSE              = 0xBADD,
    SMSG_RESEARCH_COMPLETE                            = 0xBADD,
    SMSG_RESET_COMPRESSION_CONTEXT                    = 0xBADD,
    SMSG_RESET_FAILED_NOTIFY                          = 0x26E0,
    ...
    SMSG_SCENARIO_PROGRESS_UPDATE                     = 0x2647,
    ...
    SMSG_SEND_RAID_TARGET_UPDATE_ALL                  = 0x2649,
    ...
    SMSG_SERVER_FIRST_ACHIEVEMENTS                    = 0x2668,
    SMSG_SERVER_TIME                                  = 0x26A9,
    ...
    SMSG_SET_DUNGEON_DIFFICULTY                       = 0x26CC,
    SMSG_SET_FACTION_AT_WAR                           = 0x273B,
    ...
    SMSG_SPECIAL_MOUNT_ANIM                           = 0x26C6,
    ...
    SMSG_START_MIRROR_TIMER                           = 0x274C,
    SMSG_START_TIMER                                  = 0xBADD,
    SMSG_STOP_ELAPSED_TIMER                           = 0x261B,
    SMSG_STOP_MIRROR_TIMER                            = 0x274E,
    ...
    SMSG_TAXI_NODE_STATUS                             = 0x26A3,
    SMSG_TEXT_EMOTE                                   = 0x26A1,
    SMSG_THREAT_CLEAR                                 = 0x270E,
    SMSG_THREAT_REMOVE                                = 0x270D,
    SMSG_THREAT_UPDATE                                = 0x270C,
    SMSG_TIME_ADJUSTMENT                              = 0x2DA1,
    SMSG_TIME_SYNC_REQUEST                            = 0x2DA0,
    SMSG_TITLE_EARNED                                 = 0x2709,
    ...
    SMSG_UNDELETE_COOLDOWN_STATUS_RESPONSE            = 0x2803,
    ...
    SMSG_UPDATE_EXPANSION_LEVEL                       = 0x2661,
    SMSG_UPDATE_INSTANCE_OWNERSHIP                    = 0x26AA,
    SMSG_UPDATE_LAST_INSTANCE                         = 0x26AF,
    SMSG_UPDATE_OBJECT                                = 0x2800,
    SMSG_UPDATE_TALENT_DATA                           = 0x25EA,
    SMSG_UPDATE_TASK_PROGRESS                         = 0x27CB,
    SMSG_UPDATE_WEEKLY_SPELL_USAGE                    = 0xBADD,
    SMSG_UPDATE_WORLD_STATE                           = 0x2789,
    SMSG_WOW_TOKEN_UPDATE_AUCTIONABLE_LIST_RESPONSE   = 0xBADD,
    SMSG_USE_EQUIPMENT_SET_RESULT                     = 0x278F,
    SMSG_USERLIST_ADD                                 = 0x2BBE,
    SMSG_USERLIST_REMOVE                              = 0x273C,
...
inline std::string GetOpcodeNameForLogging(T id)
{
    ...
    {
        if (OpcodeHandler const* handler = opcodeTable[T(opcode & MAX_OPCODE)])
            ss << handler->Name;
        else
            ss << "UNKNOWN OPCODE";
    }
