...
void AuraApplication::BuildUpdatePacket(WorldPackets::Spells::AuraInfo& auraInfo, bool remove, uint32 overrideAura) const
{
    ...
    auraData.CastGuid = ObjectGuid::Create<HighGuid::Cast>(GetTarget()->GetMapId(), (overrideAura ? overrideAura : aura->GetId()), sObjectMgr->GetGenerator<HighGuid::Cast>()->Generate(), 3);
