...
void Creature::Regenerate(Powers power)
{
    ...
    uint32 sendInterval = (isAnySummons() ? PET_FOCUS_REGEN_INTERVAL : (GetCreatureTemplate()->Classification == CREATURE_ELITE_WORLDBOSS ? BOSS_REGEN_INTERVAL : CREATURE_REGEN_INTERVAL));
