...
class Unit : public WorldObject
{
    public:
        ...
        */
        ...
        bool isDead() const { return (m_deathState == DEAD || m_deathState == CORPSE || HasFlag(OBJECT_FIELD_DYNAMIC_FLAGS, UNIT_DYNFLAG_DEAD) || HasFlag(UNIT_FIELD_FLAGS_2, UNIT_FLAG2_FEIGN_DEATH)); };
