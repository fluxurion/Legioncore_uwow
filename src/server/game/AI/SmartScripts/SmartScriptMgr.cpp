        ...
        switch (type)
        {
            ...
            case SMART_EVENT_SPELLHIT_TARGET:
                if (e.event.spellHit.spell)
                {
                    ...
                    if (e.event.spellHit.school && (e.event.spellHit.school & spellInfo->Misc.SchoolMask) != spellInfo->Misc.SchoolMask)
                    {
            ...
            case SMART_EVENT_RESPAWN:
                ...
                if (e.event.respawn.type == SMART_SCRIPT_RESPAWN_CONDITION_AREA && !sDB2Manager.GetAreaEntryByAreaID(e.event.respawn.area))
                {
