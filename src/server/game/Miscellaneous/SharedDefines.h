...
enum SpellCastResult // 21021
{
    ...
    SPELL_FAILED_NO_COMBO_POINTS = 96,
    SPELL_FAILED_NO_DUELING = 97,
    SPELL_FAILED_NO_ENDURANCE = 98,
    SPELL_FAILED_NO_FISH = 99,
    SPELL_FAILED_NO_ITEMS_WHILE_SHAPESHIFTED = 100,
    SPELL_FAILED_NO_MOUNTS_ALLOWED = 101,
    SPELL_FAILED_NO_PET = 102,
    SPELL_FAILED_NO_POWER = 103,
    SPELL_FAILED_NOTHING_TO_DISPEL = 104,
    SPELL_FAILED_NOTHING_TO_STEAL = 105,
    SPELL_FAILED_ONLY_ABOVEWATER = 106,
    SPELL_FAILED_ONLY_DAYTIME = 107,
    SPELL_FAILED_ONLY_INDOORS = 108,
    SPELL_FAILED_ONLY_MOUNTED = 109,
    SPELL_FAILED_ONLY_NIGHTTIME = 110,
    ...
    SPELL_FAILED_NOT_WHILE_MERCENARY = 268,
    SPELL_FAILED_SPEC_DISABLED = 269,
    SPELL_FAILED_CANT_BE_OBLITERATED = 270,
    SPELL_FAILED_UNKNOWN = 271,
