...
DB2Storage<ArtifactEntry>                   sArtifactStore("Artifact.db2", ArtifactFormat, HOTFIX_SEL_ARTIFACT);
DB2Storage<ArtifactAppearanceEntry>         sArtifactAppearanceStore("ArtifactAppearance.db2", ArtifactAppearanceFormat, HOTFIX_SEL_ARTIFACT_APPEARANCE);
DB2Storage<ArtifactAppearanceSetEntry>      sArtifactAppearanceSetStore("ArtifactAppearanceSet.db2", ArtifactAppearanceSetFormat, HOTFIX_SEL_ARTIFACT_APPEARANCE_SET);
DB2Storage<ArtifactCategoryEntry>           sArtifactCategoryStore("ArtifactCategory.db2", ArtifactCategoryFormat, HOTFIX_SEL_ARTIFACT_CATEGORY);
DB2Storage<ArtifactPowerEntry>              sArtifactPowerStore("ArtifactPower.db2", ArtifactPowerFormat, HOTFIX_SEL_ARTIFACT_POWER);
DB2Storage<ArtifactPowerLinkEntry>          sArtifactPowerLinkStore("ArtifactPowerLink.db2", ArtifactPowerLinkFormat, HOTFIX_SEL_ARTIFACT_POWER_LINK);
DB2Storage<ArtifactPowerRankEntry>          sArtifactPowerRankStore("ArtifactPowerRank.db2", ArtifactPowerRankFormat, HOTFIX_SEL_ARTIFACT_POWER_RANK);
DB2Storage<ArtifactQuestXPEntry>            sArtifactQuestXPStore("ArtifactQuestXP.db2", ArtifactQuestXPFormat, HOTFIX_SEL_ARTIFACT_QUEST_XP);
DB2Storage<ArtifactUnlockEntry>             sArtifactUnlockStore("ArtifactUnlock.db2", ArtifactUnlockFormat, HOTFIX_SEL_ARTIFACT_UNLOCK);
