...
char const ItemLimitCategoryEntryFormat[] = "nxii";
...
char const ItemSetSpellEntryFormat[] = "niiii";
...
char const MailTemplateEntryFormat[] = "s";
...
char const QuestSortEntryFormat[] = "s";
...
char const SpellAuraOptionsEntryFormat[] = "nxxiiiiii";
...
char const SpellCategoriesEntryFormat[] = "itttbbbbb";
char const SpellCategoryEntryFormat[] = "sibbb";
char const SpellClassOptionsFormat[] = "niiiiii";
char const SpellCooldownsEntryFormat[] = "iiiib";
char const SpellDurationFormat[] = "iit";
char const SpellEffectEntryFormat[] = "ifiiffiiiiffiiiiifiifttbbbbbbbbb";
char const SpellEffectScalingEntryFormat[] = "fffi";
char const SpellEntryFormat[] = "nssxxiiiiiiiiiiiiiiiiiii";
char const SpellEquippedItemsEntryFormat[] = "iiib";
char const SpellFocusObjectFormat[] = "s";
char const SpellInterruptsEntryFormat[] = "iiiiitb";
char const SpellItemEnchantmentConditionFormat[] = "bbbbbbbbbbbbbbbbbbbbbbbbbbbbbb";
char const SpellLearnSpellFormat[] = "niii";
char const SpellLevelsEntryFormat[] = "itttb";
char const SpellMiscFormat[] = "niiiiiiiiiiiiiiiiifiiiiif";
char const SpellPowerFormat[] = "niiiiiiiiiffif";
char const SpellProcsPerMinuteEntryFormat[] = "fb";
char const SpellProcsPerMinuteModEntryFormat[] = "ftbb";
...
char const SpellScalingEntryFormat[] = "diiiifiii";
char const SpellShapeshiftEntryFormat[] = "nixixx";
char const SpellShapeshiftFormFormat[] = "sfittttttttttttttbbb";
char const SpellTargetRestrictionsEntryFormat[] = "iffittbb";
