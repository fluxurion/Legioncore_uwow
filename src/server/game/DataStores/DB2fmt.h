...
char const ArtifactFormat[] = "nsiiitbbb";
char const ArtifactAppearanceFormat[] = "nsiffitbbbbbb";
char const ArtifactAppearanceSetFormat[] = "nssttbbb";
char const ArtifactCategoryFormat[] = "ntt";
char const ArtifactPowerFormat[] = "nfftbbb";
char const ArtifactPowerLinkFormat[] = "ntt";
char const ArtifactPowerRankFormat[] = "nifttb";
char const ArtifactQuestXPFormat[] = "ntttttttttt";
char const ArtifactUnlockFormat[] = "nttbb";
...
char const BattlePetAbilityTurnFormat[] = "nttbbb";
char const BattlePetBreedQualityFormat[] = "nfb";
char const BattlePetBreedStateFormat[] = "ntbb";
char const BattlePetEffectPropertiesFormat[] = "nssssssbbbbbbb";
...
char const ResearchProjectFormat[] = "nssistbbb";
char const ResearchSiteFormat[] = "nistb";
