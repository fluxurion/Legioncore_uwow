...
char const BattlemasterListFormat[] = "niiiiiiiiiiiiiiiiixsiiiiiiiixxx";
...
char const CharSectionsFormat[] = "iiiisssiii";
...
char const ChrClassesFormat[] = "nixsxxxixiiiiixxxxx";
...
char const CreatureModelDataFormat[] = "niixxxxxxxxxxxxffxxxxxxxxxxxxxxxxxxx";
...
char const FactionFormat[] = "niiiiiiiiiiiiiiiiiiffixsxxix";
char const FactionTemplateFormat[] = "niiiiiiiiiiiii";
...
char const GemPropertiesFormat[] = "ntt";
...
char const ItemAppearanceFormat[] = "iniib";
...
char const MapDifficultyFormat[] = "diisiiii";
...
char const SpellItemEnchantmentFormat[] = "niiiiiiiiiixiiiiiiiiiiifff";
...
char const TalentFormat[] = "niiiixxxiis";
