...
ALTER TABLE `areatrigger_involvedrelation` RENAME `areatrigger_questender`;
...
UPDATE `command` SET
    `name` = 'reload areatrigger_questender',
    `help` = 'Syntax: .reload areatrigger_questender\nReload areatrigger_questender table.'
WHERE
    `name` = 'reload areatrigger_involvedrelation';